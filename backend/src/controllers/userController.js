...
const validateUserInfo = [
    ...
    body("about")
        ...
        .matches(/^[a-zA-Z0-9!@#$%^&*()[\]{}.,\/<>?;:'"\-_+=~ ]*$/)
        .withMessage(
            `About me can only contain letters, numbers, spaces, and common special characters.`
        )
]

const updateInfo = [passport.authenticate('jwt', { session: false }), validateUserInfo,
async (req, res, next) => {
